...
- `DashboardLayout.tsx` — Sidebar with owner groups list, user profile, license info, Tools section (AI Assistant, Competitors, Limited Sniper), Community & Settings links, Online Users presence section (green dot indicators, avatars, real-time via WebSocket)
