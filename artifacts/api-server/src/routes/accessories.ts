...
const SEED_ACCESSORIES = [
  ...
  { name: "Sakura Frame", nameRu: "Рамка Сакура", nameEs: "Marco Sakura", description: "Beautiful sakura blossom frame", descriptionRu: "Красивая рамка с цветами сакуры", descriptionEs: "Hermoso marco de flor de sakura", icon: "🌸", category: "frame", rarity: "epic", obtainMethod: "minigame" },
  { name: "Rose Wreath", nameRu: "Венок из роз", nameEs: "Corona de rosas", description: "Elegant rose wreath around avatar", descriptionRu: "Элегантный венок из роз", descriptionEs: "Elegante corona de rosas", icon: "🌹", category: "frame", rarity: "rare", obtainMethod: "minigame" },
  { name: "Lightning Ring", nameRu: "Кольцо молний", nameEs: "Anillo de relámpagos", description: "Electric lightning ring frame", descriptionRu: "Электрическое кольцо молний", descriptionEs: "Anillo de relámpagos eléctricos", icon: "⚡", category: "frame", rarity: "epic", obtainMethod: "minigame" },
  { name: "Crosshair Frame", nameRu: "Рамка Прицел", nameEs: "Marco de mira", description: "Tactical crosshair frame", descriptionRu: "Тактическая рамка прицел", descriptionEs: "Marco de mira táctico", icon: "🎯", category: "frame", rarity: "rare", obtainMethod: "minigame" },
  { name: "Dragon Ring", nameRu: "Кольцо дракона", nameEs: "Anillo del dragón", description: "Legendary dragon frame", descriptionRu: "Легендарное кольцо дракона", descriptionEs: "Anillo legendario del dragón", icon: "🐉", category: "frame", rarity: "legendary", obtainMethod: "minigame" },
  { name: "Pixel Frame", nameRu: "Пиксельная рамка", nameEs: "Marco de píxeles", description: "Retro pixel art frame", descriptionRu: "Ретро пиксельная рамка", descriptionEs: "Marco de arte pixelado retro", icon: "👾", category: "frame", rarity: "common", obtainMethod: "minigame" },
  { name: "Butterfly Frame", nameRu: "Рамка с бабочками", nameEs: "Marco de mariposas", description: "Delicate butterfly frame", descriptionRu: "Нежная рамка с бабочками", descriptionEs: "Marco delicado de mariposas", icon: "🦋", category: "frame", rarity: "rare", obtainMethod: "minigame" },
  { name: "Skull Ring", nameRu: "Кольцо черепов", nameEs: "Anillo de calaveras", description: "Dark skull ring frame", descriptionRu: "Тёмное кольцо черепов", descriptionEs: "Anillo oscuro de calaveras", icon: "💀", category: "frame", rarity: "epic", obtainMethod: "minigame" },
  { name: "Rainbow Ring", nameRu: "Радужное кольцо", nameEs: "Anillo arcoíris", description: "Colorful rainbow ring", descriptionRu: "Красочное радужное кольцо", descriptionEs: "Anillo colorido arcoíris", icon: "🌈", category: "frame", rarity: "common", obtainMethod: "minigame" },
  { name: "Stars Frame", nameRu: "Звёздная рамка", nameEs: "Marco de estrellas", description: "Sparkling stars frame", descriptionRu: "Сверкающая звёздная рамка", descriptionEs: "Marco de estrellas brillantes", icon: "✨", category: "frame", rarity: "rare", obtainMethod: "minigame" },
  { name: "Emerald Frame", nameRu: "Изумрудная рамка", nameEs: "Marco esmeralda", description: "A rich emerald green frame", descriptionRu: "Богатая изумрудная рамка", descriptionEs: "Un marco verde esmeralda", icon: "💚", category: "frame", rarity: "rare", obtainMethod: "quest" },
  { name: "Obsidian Frame", nameRu: "Обсидиановая рамка", nameEs: "Marco obsidiana", description: "Dark and mysterious obsidian frame", descriptionRu: "Тёмная и загадочная обсидиановая рамка", descriptionEs: "Marco oscuro y misterioso de obsidiana", icon: "🖤", category: "frame", rarity: "epic", obtainMethod: "quest" },
  { name: "Crystal Frame", nameRu: "Кристальная рамка", nameEs: "Marco cristal", description: "Brilliant crystal frame", descriptionRu: "Сверкающая кристальная рамка", descriptionEs: "Marco de cristal brillante", icon: "💎", category: "frame", rarity: "legendary", obtainMethod: "quest" },
  { name: "Sunset Glow Frame", nameRu: "Рамка Закатное сияние", nameEs: "Marco Brillo del atardecer", description: "Warm sunset glow frame", descriptionRu: "Тёплая рамка закатного сияния", descriptionEs: "Marco cálido del brillo del atardecer", icon: "🌅", category: "frame", rarity: "epic", obtainMethod: "quest" },
  { name: "Toxic Green Frame", nameRu: "Токсичная зелёная рамка", nameEs: "Marco verde tóxico", description: "Radioactive green frame", descriptionRu: "Радиоактивная зелёная рамка", descriptionEs: "Marco verde radioactivo", icon: "☢️", category: "frame", rarity: "rare", obtainMethod: "quest" },
...
async function seedIfEmpty() {
  for (let attempt = 1; attempt <= 3; attempt++) {
    try {
      ...
      const allAccForFix = await db.select().from(accessories);
      for (const acc of allAccForFix) {
        if (ICON_FIXES[acc.icon]) {
          await db.update(accessories).set({ icon: ICON_FIXES[acc.icon] }).where(eq(accessories.id, acc.id));
        }
      }
