    ...
    <div className="flex h-screen w-full bg-secondary/30 overflow-hidden">
      <div className="w-72 bg-card border-r border-border/60 flex flex-col shadow-2xl shadow-black/5 z-20">
        ...
        <div className="px-4 pt-4 space-y-1">
          <NavItem href="/profile" icon={<UserCircle className="w-4 h-4" />} label="My Profile" isActive={location === "/profile"} />
          <NavItem href="/community" icon={<MessageSquare className="w-4 h-4" />} label="Community" isActive={location === "/community"} />
        </div>
